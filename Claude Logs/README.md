# Claude Logs — Persistent Claude Code Logging System
...
1. **`/CLAUDE.md`** — stable project rules and engineering priorities (if present).
2. **`Claude Logs/CURRENT_CONTEXT.md`** — where things stand right now.
3. **`Claude Logs/SESSION_INDEX.md`** — scan for relevant past sessions.
4. **The latest relevant `logs/*.md`** — the most recent detailed entry (and any
   older one related to your task).

After reading these, state your understanding of the current state and your
...
- **Log file naming:** `YYYY-MM-DD_<short-kebab-task-slug>.md`
  (e.g. `2026-07-20_claude-logging-setup.md`). If two sessions happen on
